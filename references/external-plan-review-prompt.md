...
Claude CLI handoffs must not use `--bare`; preserve the normal logged-in session while disabling conversation persistence and limiting tools/directories for read-only review.
